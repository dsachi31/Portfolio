...
export default function Portfolio() {
    ...
    const headStyle = {
        fontFamily: 'DM Sans, sans-serif', textTransform: 'none', color: '#fff', fontSize: '17px', '&:hover': { textDecoration: "underline", }
        ...
        <div className="App" style={{
            ...
            <Grid container spacing={2} sx={{
                ...
                <Grid size={6} sx={{
                    ...
                    <Box sx={{
                        margin: '20px 50px 50px 0px', padding: '20px 20px 20px 0px',
                        display: 'flex', justifyContent: 'flex-start', alignItems: 'center', gap: '20px'
                    }}>
